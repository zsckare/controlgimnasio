...
<?php include 'navegacion.php';?>
  ...
  <div class="container">
    <div class="card paddin-largo">
        ...
        <form action="editarC.php" method="POST" class="col m12" enctype="multipart/form-data">
      <input type="hidden" value="'.$id.'" name="id">
       <input type="hidden" value="'.$row['activo'].'" name="activo">
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="input-field col s6">
              ...
              <input id="ocu" type="text" name="ocupacion" value="'.$row[10].'" >
            </div>
          </div>
          <div class="row">
